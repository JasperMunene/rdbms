...
# Index Configuration
INDEX_ORDER = 4  # B+ Tree order (max children per internal node)
INDEX_LEAF_ORDER = 3  # Max keys per leaf node

# Index Page Types
INDEX_TYPE_LEAF = 0
INDEX_TYPE_INTERNAL = 1
INDEX_TYPE_ROOT = 2
...
# Constraint Types
CONSTRAINT_PRIMARY_KEY = 0
CONSTRAINT_UNIQUE = 1
CONSTRAINT_FOREIGN_KEY = 2
